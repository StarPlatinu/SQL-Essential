...
ALTER TABLE Employee  
ADD  CONSTRAINT [FK_Mgt] FOREIGN KEY([EmpNo])
REFERENCES Employee (MgrNo)
...
--c2
select e.EmpName,count(s.SkillNo) as [Skill Number] 
from Employee e Left Join Emp_Skill s
 on  e.EmpNo = s.SkillNo
 Group by s.SkillNo
 Go
